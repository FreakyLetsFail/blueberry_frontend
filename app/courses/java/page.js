      ...
      <main className="flex-1 h-full overflow-y-auto flex flex-col relative bg-zinc-950">
        ...
        <div className="p-8 max-w-5xl mx-auto w-full">
            <div className="mb-12 text-center">
                ...
                <h1 className="text-4xl font-bold mb-4 tracking-tight">Java Programming Path</h1>
                        ...
                        <div className="p-8 flex flex-col md:flex-row items-start md:items-center gap-6">
                            ...
                            <div className="flex flex-col items-end gap-4 min-w-[140px]">
                                ...
                                {module.status === 'active' ? (
                                    <Link href={`/courses/java/${module.id}`}>
                                        <Button className="bg-white text-black font-bold rounded-xl px-6">
                                            Continue Path
                                        </Button>
                                    </Link>
                                ) : module.status === 'locked' ? (
                                    <Button disabled className="bg-zinc-800 text-zinc-500 font-bold rounded-xl px-6 opacity-50 cursor-not-allowed">
                                        Locked
                                    </Button>
                                ) : (
                                    <Link href={`/courses/java/${module.id}`}>
                                        <Button variant="bordered" className="border-zinc-700 text-white font-bold rounded-xl px-6">
                                            Review
                                        </Button>
                                    </Link>
                                )}
